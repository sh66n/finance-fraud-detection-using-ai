...
const eventSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['Hackathon', 'Project Competition', 'Coding Competition', 'Other'],  // Add categories as needed
    required: true,
  },
  time: {
    type: String,
...
const StudentEvent = mongoose.models.StudentEvent || mongoose.model('StudentEvent', eventSchema);
